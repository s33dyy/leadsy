...
export const envSchema = z.object({
  ...
  AI_DEFAULT_MODEL: z.string().default("openai/gpt-5.2"),
  OPENROUTER_API_KEY: z.string().optional(),
  OPENROUTER_BASE_URL: z.url().default("https://openrouter.ai/api/v1"),
  OPENROUTER_RESEARCH_MODEL: z.string().default("openai/gpt-5.2"),
  OPENROUTER_DOSSIER_MODEL: z.string().optional(),
  OPENROUTER_SENTIMENT_MODEL: z.string().optional(),
  OPENROUTER_FAST_MODEL: z.string().default("openai/gpt-5.2"),
