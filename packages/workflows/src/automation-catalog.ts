...
export const automationWorkflowDefinitions: AutomationWorkflowDefinition[] = [
  {
    ...
    trigger: "Leadsy scheduler or Leadsy event asks for due follow-up evaluation.",
    ...
    dependencies: ["Leadsy scheduler", "Leadsy task API"],
  ...
  },
  {
    ...
    trigger: "Leadsy scheduler finds a task, follow-up, approval, or escalation approaching its reminder window.",
  ...
  },
  {
    ...
    dependencies: ["Leadsy scheduler", "Leadsy task API"],
    retryPolicy: "Retry transient Leadsy API failures; never complete, reassign, or message a lead from background automation.",
    preserves: "Leadsy owns task records, owners, statuses, notes, and lead links."
  },
  {
    key: "escalation-triggered",
    name: "Escalation Rules",
    trigger: "Leadsy scheduler or Leadsy event detects a stale task, missed reply SLA, failed reminder, or unresolved approval.",
